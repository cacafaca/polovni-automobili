...
namespace Common.Vozilo
{
    ...
    {
        //konstatnte
        public readonly int maxDuzOpis = 4000;
        public readonly int maxDuzKontakt = 4000;
            ...
            )
        {
            ...
            this.opis = opis.Length <= maxDuzOpis ? opis : opis.Remove(maxDuzOpis);
            this.kontakt = kontakt.Length <= maxDuzKontakt ? kontakt : kontakt.Remove(maxDuzKontakt);
        }
